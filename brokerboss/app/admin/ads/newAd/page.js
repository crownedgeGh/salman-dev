...
export default function NewAdPage() {
  ...
  const handleSubmit = (e) => {
    ...
    setSubmitted(true);
    showToast("Ad post created successfully!");
    setTimeout(() => {
    ...
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-0.5">
          Configure details and upload creative banners/stories.
        </p>
      </div>
      ...
      <div className="p-6 rounded-xl border border-border bg-card shadow-sm space-y-6">
        {submitted ? (
          <div className="flex flex-col items-center justify-center gap-4 py-12 text-center">
            ...
            <h2 className="text-xl font-bold">Successfully Posted!</h2>
            <p className="text-muted-foreground text-sm">
              The new ad has been queued and activated. Redirecting...
              {form.imageUrl && <span className="hidden">{form.imageUrl}</span>}
            </p>
          </div>
        ) : (
